...
| `SQL_MAX_IDLE_CONNS` | Nombre max de connexions inactives à la base | `20` |
| `SQL_MAX_OPEN_CONNS` | Nombre max de connexions ouvertes à la base | `80` |
| `SQL_MAX_LIFETIME` | Durée de vie max d'une connexion BD (secondes) | `600` |
